...
spiSpy(true);
# if PRMFUNC
    printf("API: Setting Accel FSR to 4g \r\n");
	...
	printf("Simply Setting Accel FSR to 2g \r\n");
...
#else	
	//accel FSR=4g
			printf("Simply Setting Accel FSR to 4g \r\n");
...
#endif	
spiSpy(false);
printf(" press any key to continue "); getchar(); printf(" got it \r\n");
